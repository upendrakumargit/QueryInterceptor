...
public class HikariDataSourceWrapperClient {

  public static void main(String[] args) {
    final HikariDataSourceWrapper pool = new HikariDataSourceWrapper();
    Connection connection = null;
    PreparedStatement preparedStatement = null;
    ResultSet resultSet = null;
    try {
      pool.setDriverClassName("com.apple.gbi.gsf.multiplex.driver.GbiTeradataDriverWrapper");
      pool.setJdbcUrl("jdbc:gbiteradatamultiplex://EDWUAT.corp.apple.com/charset=UTF8,DBS_PORT=1025");
      pool.setUsername("<#USERNAME>");
      pool.setPassword("<#PASSWORD>");
      pool.setQdbHint("/*QDBHINT VPOD11*/");
      // https://github.com/brettwooldridge/HikariCP/issues/288
      // https://github.com/brettwooldridge/HikariCP/issues/401
