...
public class HikariJNDIFactoryWrapper extends HikariJNDIFactory {
  
  @Override
  public Object getObjectInstance(Object obj, Name name, Context nameCtx,
      Hashtable<?, ?> environment) throws Exception {
    System.out.println("Started initialization of HikariJNDIFactoryWrapper#getObjectInstance");
    ...
    System.out.println("HikariJNDIFactoryWrapper initialized for resource name [" + name
