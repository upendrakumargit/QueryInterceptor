...
public abstract class AbstractConnectionWrapper implements Connection {
  ...
  public AbstractConnectionWrapper(final Connection delegate) {
  ...
  public PreparedStatement prepareStatement(String sql) throws SQLException {
    return new PreparedStatementWrapper(this.delegate.prepareStatement(sql));
  }

  @Override
  public CallableStatement prepareCall(String sql) throws SQLException {
    return new CallableStatementWrapper(this.delegate.prepareCall(sql));
  }
  ...
  public <T> T unwrap(Class<T> iface) throws SQLException {
    return iface.cast(this.delegate);
  }
  ...
  public void close() throws SQLException {
    try {
      ...
      // handling error when connection is already closed
      // just supress the error and log it 
  ...
  public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency)
      throws SQLException {
    return new PreparedStatementWrapper(this.delegate.prepareStatement(sql, resultSetType,
  ...
  public CallableStatement prepareCall(String sql, int resultSetType, int resultSetConcurrency)
      throws SQLException {
    return new CallableStatementWrapper(this.delegate.prepareCall(sql, resultSetType,
        resultSetConcurrency));
  }
  ...
  public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
    return new PreparedStatementWrapper(this.delegate.prepareStatement(sql, autoGeneratedKeys));
  }

  @Override
  public PreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
    return new PreparedStatementWrapper(this.delegate.prepareStatement(sql, columnIndexes));
  }

  @Override
  public PreparedStatement prepareStatement(String sql, String[] columnNames) throws SQLException {
    return new PreparedStatementWrapper(this.delegate.prepareStatement(sql, columnNames));
  }
